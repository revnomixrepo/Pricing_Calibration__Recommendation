...
def getRecommendations(db_confg, pid, start_date):
    ...
    myquery = ("select distinct hotel_code as propertydetailsid, " +
               ...
               "FROM rm_rates where hotel_code in (" + comp_ids +") " +
               "and checkin_date between '" + start_date + "' and '" + end_date + "' " +
               "and date_collected >= '" + clt_date + "' order by hotel_code, checkin_date;")
